...
{
    /// <summary>
    /// Base class for behavior that will bind SelectedItems using a property in each item insted of entire collection of <see cref="ListViewBase.SelectedItems"/>. Supports <see cref="ListBox"/> and classes inherited from <see cref="ListViewBase"/>.
    /// </summary>
                ...
                try
                {
                    foreach (var item in items)
                    {
                        if (IsSelected(item))
                        {
                            ...
                            else if (AssociatedObject is ListViewBase listView)
                            {
